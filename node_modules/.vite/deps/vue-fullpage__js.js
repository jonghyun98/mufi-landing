...
// node_modules/vue-fullpage.js/dist/vue-fullpage.mjs
  ...
  (function(ne, ie) {
    ...
    function Ui() {
      if (!o().anchors.length) {
        ...
        e.length && e.length === s(o().sectionSelector, et).length && (Zi = true, e.forEach(function(n) {
    ...
    var c = { A: 0, O: 0, slides: [], R: [], D: null, L: null, j: false, N: false, I: false, P: false, H: false, C: void 0, W: void 0, F: false, canScroll: true, V: "none", B: "none", Z: false, Y: false, G: true, X: 0, U: F(), _: false, J: {}, scrollY: 0, scrollX: 0, K: false };
    function p(e) {
      Object.assign(c, e);
    }
    function u() {
    ...
    function Oe(e) {
      ...
      if (o().css3 && o().autoScrolling && !o().scrollBar)
        no("translate3d(0px, -" + t + "px, 0px)", false);
    ...
    function jt(e, t, n, i) {
      ...
      }(e), l = t - a, v = false, f = c.F;
      p({ F: true }), nt && window.cancelAnimationFrame(nt), nt = function(b) {
        r || (r = b);
        var x = Math.floor(b - r);
        if (c.F) {
          var w = t;
          n && (w = y.fp_easings[o().easing](x, a, l, n)), x <= n && to(e, w), x < n ? window.requestAnimationFrame(nt) : i === void 0 || v || (i(), p({ F: false }), v = true);
        } else
          v || f || (i(), p({ F: false }), v = true);
    ...
    function Re(e, t, n) {
      ...
      l.xMovement = xo(l.prevSlideIndex, l.slideIndex), l.direction = l.direction ? l.direction : l.xMovement, l.localIsResizing || p({ canScroll: false }), S("parallax", "applyHorizontal", l), S("cards", "apply", l), S("dropEffect", "apply", l), S("waterEffect", "apply", l), o().onSlideLeave && !l.localIsResizing && l.xMovement !== "none" && z(o().onSlideLeave) && se("onSlideLeave", l) === false ? p({ I: false }) : (B("dropEffect") && o().dropEffect || (E(t, k), N(We(t), k)), ce(), l.localIsResizing || (Cn(l.prevSlide), ot(a)), yo(l), r.isActive && !l.localIsResizing && kn(l.slideIndex, l.slideAnchor, l.anchorLink), S("continuousHorizontal", "apply", l), d.ln(zn, l), qi() ? _n(l) : bo(e, l, true), o().interlockedSlides && h.interlockedSlides && (B("continuousHorizontal") && n !== void 0 && n !== l.xMovement || S("interlockedSlides", "apply", l)));
    }
    function bo(e, t, n) {
      var i = t.destinyPos;
    ...
    function ce() {
      c.D = null, c.R.map(function(e) {
        ...
        if (!e && c.R.length && !u().j) {
          if (Vn) {
            var i = Ao(Vn, c.R);
            i && (c.D = i, c.D.isActive = true, E(c.D.item, k)), c.D && Oe(c.D.item.offsetTop);
          }
          if (t && !n && Yn) {
            var r = Ao(Yn, c.D.slides);
            r && (c.D.activeSlide = r, c.D.activeSlide.isActive = true, E(c.D.activeSlide.item, k)), c.D.activeSlide && at(c.D.activeSlide.item, "internal");
          }
        }
    ...
    function se(e, t) {
      ...
      return q(g(), e, n), o()[e].apply(n[Object.keys(n)[0]], Bo(n)) !== false;
    }
    function Wn(e, t) {
    ...
    var Un, Gn, qn, Kn, ct, $n, Rr = (Gn = true, qn = (/* @__PURE__ */ new Date()).getTime(), Kn = !y.fullpage_api, function(e, t) {
      ...
      if (i != null) {
        ...
        if (!(u().D.item == i && !c.P || o().scrollBar && ye() === l.dtop && !O(i, "fp-auto-height"))) {
          if (l.activeSlide != null && (r = H(l.activeSlide, "data-anchor"), a = de(l.activeSlide, null)), !l.localIsResizing) {
            var v = l.yMovement;
            if (n !== void 0 && (v = n ? "up" : "down"), l.direction = v, Gi("dropEffect") && h.dropEffect.onLeave_(l), Gi("waterEffect") && h.waterEffect.onLeave_(l), z(o().beforeLeave) && Mo("beforeLeave", l) === false || z(o().onLeave) && !se("onLeave", l))
              return;
          }
          S("parallax", "apply", l), S("cards", "apply", l), S("dropEffect", "apply", l), S("waterEffect", "apply", l), o().autoScrolling && o().continuousVertical && l.isMovementUp !== void 0 && (!l.isMovementUp && l.yMovement == "up" || l.isMovementUp && l.yMovement == "down") && (l = function(f) {
            ...
            if (o().css3 && o().autoScrolling && !o().scrollBar)
              no("translate3d(0px, -" + Math.round(f.dtop) + "px, 0px)", true), B("waterEffect") && Xn(), o().scrollingSpeed ? (clearTimeout(ct), ct = setTimeout(function() {
    ...
    function Vt(e) {
      ...
      }(e), z(o().afterLoad) && !e.localIsResizing && se("afterLoad", e), S("parallax", "afterLoad"), S("waterEffect", "afterLoad"), S("dropEffect", "afterLoad"), S("scrollOverflowReset", "reset"), S("resetSliders", "apply", e), ce(), e.localIsResizing || Pt(e.element), E(e.element, Ie), N(We(e.element), Ie), To(), p({ canScroll: true }), d.ln(lt, e), z(e.callback) && e.callback();
    }
    function Qn(e, t) {
      tt("fitToSection", e, t);
    }
    function Oo() {
      c.canScroll && o().fitToSection && (p({ P: true }), Ve(c.D), p({ P: false }));
    }
    function Co() {
    ...
    var ii, st, m = { Mn: null, Tn: true, An: true, xn: null, On: null, kn: function(e) {
      var t = u().D;
      ...
      clearTimeout(ei), m.An = false;
    }, afterLoad: function() {
      m.An = false, clearTimeout(ei), ei = setTimeout(function() {
        m.Tn = c.canScroll;
      }, 200);
    }, Rn: function() {
      T.activeElement === this.Mn && (this.Mn.blur(), m.An = false);
    }, Sn: function() {
      if (o().scrollOverflow && m.Tn) {
        m.Rn();
        var e = m.Dn(u().D.item);
        !e || me || Ae || (this.Mn = e, requestAnimationFrame(function() {
          e.focus({ Ln: true }), m.An = true;
        })), m.Tn = false;
      }
    }, bn: function() {
      o().scrollOverflowMacStyle && !br && E(R, "fp-scroll-mac"), u().rn.forEach(function(e) {
        if (!(e.slides && e.slides.length || O(e.item, "fp-auto-height-responsive") && Jn())) {
          ...
          e.q || (m.jn(n), m.zn(n)), e.q = true;
        }
      });
    }, zn: function(e) {
      m.Dn(e).addEventListener("scroll", m.Nn), e.addEventListener("wheel", m.kn, { passive: false }), e.addEventListener("keydown", m.En, { passive: false });
    }, jn: function(e) {
    ...
    function li(e, t, n) {
      ...
      for (var r = 0; r < e.length; r++) {
        var a = e[r];
        (n && !r || !n) && (i = t.cloneNode(true), a.parentNode.insertBefore(i, a)), i.appendChild(a);
      }
      return e;
    }
    function Xt(e, t) {
    ...
    function q(e, t, n) {
      var i;
      n = n === void 0 ? {} : n, typeof y.CustomEvent == "function" ? i = new CustomEvent(t, { detail: n }) : (i = T.createEvent("CustomEvent")).initCustomEvent(t, true, true, n), e.dispatchEvent(i);
    }
    function _(e, t) {
    ...
    window.fp_utils = Object.assign(y.fp_utils || {}, { $: s, deepExtend: je, hasClass: O, getWindowHeight: F, css: C, prev: Ft, next: dt, last: jo, index: de, getList: we, hide: Wt, show: ri, isArrayOrList: Ye, addClass: E, removeClass: N, appendTo: Fe, wrap: li, wrapAll: Xt, wrapInner: ai, unwrap: Zt, closest: M, after: pt, before: Ut, insertBefore: Gt, getScrollTop: ye, siblings: We, preventDefault: W, isFunction: z, trigger: q, matches: _, toggle: qt, createElementFromHTML: be, remove: Be, filter: Po, untilAll: Kt, nextAll: ci, prevAll: si, showError: ee, scrollOverflowHandler: m }), d.un(K, function() {
      ["click", "touchstart"].forEach(function(e) {
        Pe(e, No, { passive: false });
      }), pe("focus", Pr), d.un(le, jr);
    });
    var zo = { attributes: false, subtree: true, childList: true, characterData: true };
    function _o() {
    ...
    function Ir() {
      ...
      h.test.top = -e + "px", p({ canScroll: false }), jt(t.element, t.options, o().scrollingSpeed, function() {
        setTimeout(function() {
          p({ j: true }), p({ canScroll: true });
        }, 30);
      });
    }
    function Nr() {
    ...
    function Wo() {
      ...
      p({ canScroll: false }), jt(e.element, e.options, o().scrollingSpeed, function() {
        p({ canScroll: true }), p({ j: false }), p({ Vn: false });
      });
    }
    var vi, hi, gi, Xo = (vi = false, hi = {}, gi = {}, function(e, t, n) {
      switch (e) {
        case "set":
    ...
    function ht() {
      var e = u().D.next();
      e || !o().loopBottom && !o().continuousVertical || (e = u().R[0]), e != null ? Ve(e, null, false) : g().scrollHeight < R.scrollHeight && o().scrollBar && o().scrollBeyondFullpage && d.ln(mo);
    }
    function Ze() {
      var e = u().D.prev();
      e || !o().loopTop && !o().continuousVertical || (e = ue(u().R)), e != null && Ve(e, null, true);
    }
    ...
    function St(e) {
      ...
      if (wt(e)) {
        p({ Z: true, Y: false }), o().autoScrolling && (n && !c.canScroll || o().scrollBar) && W(e);
        var i = Si(e);
        nn = i.y, mt = i.x;
    ...
    function rn(e) {
      if (o().fitToSection && p({ F: false }), wt(e)) {
        var t = Si(e);
        tn = t.y, gt = t.x;
      }
      pe("touchend", Go);
    ...
    function Ti(e) {
      ...
      }(), g().addEventListener("mousedown", nr), g().addEventListener("mouseup", ir)) : (T.addEventListener ? (ve("mousewheel", qe, false), ve("wheel", qe, false), ve("MozMousePixelScroll", qe, false)) : T.detachEvent("onmousewheel", qe), g().removeEventListener("mousedown", nr), g().removeEventListener("mouseup", ir));
    }
    function qe(e) {
        ...
        if (u().j) {
          if (L) {
            ...
            if (!(D || Xo("isNewKeyframe", "beyondFullpage") && Qt.Wn()))
              return (X = He(ue(u().R).item.offsetTop + ue(u().R).item.offsetHeight)).element.scrollTo(0, X.options), p({ Vn: false }), W(w), false;
            if (Qt.Wn())
              return L = false, p({ Vn: true }), p({ L: "wheel" }), Wo(), W(w), false;
          } else
      ...
      if (c.Y || p({ Z: false, Y: true, V: "none" }), !Y().m.down && !Y().m.up)
        return false;
      if (i)
        return true;
      if (i === false)
      ...
      if (o().autoScrolling && !en && !n) {
        ...
        var b = t - tr;
        return tr = t, b > 200 && (Ge = []), p({ B: f }), c.canScroll && !Ot() && vt(Ge, 10) >= vt(Ge, 70) && v && (p({ L: "wheel" }), Uo(a < 0 ? "down" : "up")), false;
      }
      o().fitToSection && p({ F: false });
    }
    function nr(e) {
      var t;
    ...
    function bt(e) {
      e ? (Ti(true), function() {
        if (oe.Bn && (me || Ae) && (!B("dragAndMove") || o().dragAndMove === "mouseonly")) {
          o().autoScrolling && (R.removeEventListener(oe.Bn, wi, { passive: false }), R.addEventListener(oe.Bn, wi, { passive: false }));
          var t = o().touchWrapper;
          t.removeEventListener(oe.Zn, rn), t.removeEventListener(oe.Bn, St, { passive: false }), t.addEventListener(oe.Zn, rn), t.addEventListener(oe.Bn, St, { passive: false });
        }
      }()) : (Ti(false), function() {
        if (oe.Bn && (me || Ae)) {
          o().autoScrolling && (R.removeEventListener(oe.Bn, St, { passive: false }), R.removeEventListener(oe.Bn, wi, { passive: false }));
          var t = o().touchWrapper;
          t.removeEventListener(oe.Zn, rn), t.removeEventListener(oe.Bn, St, { passive: false });
        }
      }());
    }
    ...
    function or(e, t) {
      document["fp_" + e] = t, Pe(e, rr, true);
    }
    function rr(e) {
      var t = e.type, n = false, i = t === "mouseleave" ? e.toElement || e.relatedTarget : e.target;
      i != document && i ? (t === "touchend" && (Li = false, setTimeout(function() {
        Li = true;
      }, 800)), (t !== "mouseenter" || Li) && (o().normalScrollElements.split(",").forEach(function(r) {
        if (!n) {
          var a = _(i, r), l = M(i, r);
          (a || l) && (h.shared.Un || bt(false), h.shared.Un = true, n = true);
        }
      }), !n && h.shared.Un && (bt(true), h.shared.Un = false))) : bt(true);
    }
    function ln(e, t) {
          ...
          for (var e = 0; e < 4; e++)
            lr = setTimeout(function() {
              window.requestAnimationFrame(function() {
                o().autoScrolling && !o().scrollBar && (p({ P: true }), ln(c.D.index() + 1), p({ P: false }));
              });
            }, 200 * e);
      }(), Oi = true, clearTimeout(Mi), Mi = setTimeout(function() {
        (function() {
          if (p({ P: true }), cr(""), q(g(), "onResize"), o().autoScrolling || c.j || function() {
            if (!o().autoScrolling || o().scrollBar) {
            ...
            if (!_(e, "textarea") && !_(e, "input") && !_(e, "select")) {
              var t = F();
              Math.abs(t - Di) > 20 * Math.max(Di, t) / 100 && (Ri(true), Di = t);
            }
          } else
            n = F(), i = ft(), c.U === n && ar === i || (p({ U: n }), ar = i, Ri(true));
          var n, i;
          q(g(), "onResizeEnds"), p({ P: false });
        })(), Oi = false;
      }, 400);
    }
    function Ri(e) {
      if (!O(g(), hn)) {
        ...
        var l = u().D.index();
        c.j || !l || B("fadingEffect") || B("dropEffect") || B("waterEffect") || ln(l + 1), p({ P: false }), z(o().afterResize) && e && o().afterResize.call(g(), y.innerWidth, y.innerHeight), z(o().afterReBuild) && !e && o().afterReBuild.call(g()), q(g(), "afterRebuild");
      }
    }
    function cr(e) {
    ...
    `), i = ue(c.R), r = !c.Jn || o().credits.enabled;
      ...
      d.un(co, function() {
        ...
        }(v), (f || b) && (f && n <= f.Kn && f.qn === v.split(e[0])[4] || b || f.$n) || false) });
      });
    ...
    function Jr() {
      ...
      }(), Ii(true), bt(true), _e(o().autoScrolling, "internal"), Co(), ro(), T.readyState === "complete" && vr(), pe("load", vr), pr(), sn || gr("l"), zt(), ce();
    }
    function Sr() {
      var e = o().licenseKey;
      o().licenseKey.trim() === "" ? (ee("error", "Fullpage.js requires a `licenseKey` option. Read about it on the following website:"), ee("error", "https://alvarotrigo.com/fullPage/docs/#licensekey")) : o() && c.Jn || T.domain.indexOf("alvarotrigo.com") > -1 ? e && e.length : (ee("error", "Incorrect `licenseKey`. Get one for fullPage.js version 4 here:"), ee("error", "https://alvarotrigo.com/fullPage/pricing")), O(it, Et) ? ee("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (o().continuousVertical && (o().loopTop || o().loopBottom) && (o().continuousVertical = false, ee("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), !o().scrollOverflow || !o().scrollBar && o().autoScrolling || ee("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"), !o().continuousVertical || !o().scrollBar && o().autoScrolling || (o().continuousVertical = false, ee("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), o().anchors.forEach(function(t) {
      ...
      if (R = s("body")[0], it = s("html")[0], kt = s("html, body"), !O(it, Et))
        return n = typeof e == "string" ? s(e)[0] : e, Mt.touchWrapper = n, function(i) {
          ...
          for (var i = [], r = 0; r < s(o().sectionSelector, g()).length; r++)
            i.push(0);
          return i;
        }(), options: o(), setAutoScrolling: null }), h.shared = Object.assign(h.shared, { nt: null, Un: false }), y.fullpage_api = h, y.fullpage_extensions = true, g() && (d.ln(so), te("continuousHorizontal"), te("scrollHorizontally"), te("resetSliders"), te("interlockedSlides"), te("responsiveSlides"), te("fadingEffect"), te("dragAndMove"), te("offsetSections"), te("scrollOverflowReset"), te("parallax"), te("cards"), te("dropEffect"), te("waterEffect"), S("dragAndMove", "init"), S("responsiveSlides", "init"), Jr(), d.ln(K), p({ K: true }), S("dragAndMove", "turnOffTouch")), y.fullpage_api;
      Sr();
    }
    return h.destroy = function(e) {
      q(g(), "destroy", e), _e(false, "internal"), Ii(true), bt(false), Bi(false), E(g(), hn), d.ln(le), S("dragAndMove", "destroy"), e && (Oe(0), s("img[data-src], source[data-src], audio[data-src], iframe[data-src]", g()).forEach(function(t) {
        $t(t, "src");
...
vue-fullpage.js/dist/vue-fullpage.mjs:
  (*!
  * vue-fullpage 0.2.21
  ...
  *)
*/
//# sourceMappingURL=vue-fullpage__js.js.map
